...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.parseTime = parseTime;exports.formatTime = formatTime;exports.param2Obj = param2Obj;exports.getQueryString = getQueryString;exports.getHashQueryString = getHashQueryString;exports.regExpTel = regExpTel;exports.regExpPassword = regExpPassword;exports.toast = toast;
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                 ...
                                                                                                                                                 */ /**
                                                                                                                                                     ...
                                                                                                                                                     * @returns {string}
                                                                                                                                                     */function parseTime(time, cFormat) {if (arguments.length === 0) {return null;}var format = cFormat || '{y}-{m}-{d}';var date;
...
function toast() {var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var icon = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';var width = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '4rem';var position = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'default';var time = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '2000';var type = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 'text';
  Toast({
    message: text,
    icon: icon,
    position: position });
...
var baseUrl = "http://dmf.3yx.cn:8088";
